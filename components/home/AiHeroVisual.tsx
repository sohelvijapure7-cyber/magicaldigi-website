  ...
  return (
    <div className="relative w-full max-w-[620px] aspect-[4/4] flex items-center justify-center select-none overflow-visible px-4 md:px-0">
      ...
      <motion.div
        ...
        className="absolute top-[2%] left-[-4%] md:left-[-6%] glass-card p-3 md:p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex flex-col gap-2 z-30 w-36 md:w-[170px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-[#f05a28]/30"
      >
      ...
      <motion.div
        ...
        animate="animate"
        whileHover={{ y: -5, scale: 1.02 }}
        className="absolute top-[4%] right-[-4%] md:right-[-6%] glass-card p-3 md:p-3.5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex items-center gap-2.5 z-30 w-36 md:w-[170px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-amber-500/30"
      >
      ...
      <motion.div
        ...
        animate="animate"
        whileHover={{ y: -5, scale: 1.02 }}
        className="absolute top-[35%] left-[-8%] md:left-[-12%] glass-card p-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex flex-col gap-2.5 z-30 w-36 md:w-[160px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-cyan-500/30"
      >
        <div className="flex items-center justify-between">
      ...
      <motion.div
        ...
        animate="animate"
        whileHover={{ y: -5, scale: 1.02 }}
        className="absolute top-[40%] right-[-8%] md:right-[-12%] glass-card p-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex flex-col gap-2 z-30 w-36 md:w-[160px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-[#f05a28]/30"
      >
        <div className="flex items-center justify-between">
      ...
      <motion.div
        ...
        animate="animate"
        whileHover={{ y: -5, scale: 1.02 }}
        className="absolute bottom-[-2%] left-[-4%] md:left-[-6%] glass-card p-3 md:p-3.5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex flex-col gap-2 z-30 w-44 md:w-[190px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-[#f05a28]/30"
      >
        <div className="flex items-center justify-between">
      ...
      <motion.div
        ...
        animate="animate"
        whileHover={{ y: -5, scale: 1.02 }}
        className="absolute bottom-[-4%] right-[-4%] md:right-[-6%] glass-card p-3 md:p-3.5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/[0.08] flex flex-col gap-1.5 z-30 w-36 md:w-[160px] backdrop-blur-md bg-[#0a0a14]/75 transition-all duration-300 hover:border-[#f05a28]/30"
      >
        <div className="flex items-center justify-between">
