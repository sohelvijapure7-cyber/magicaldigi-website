    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 md:px-10 lg:px-16">
          <div className="flex items-center justify-between h-36 md:h-48">
            ...
            <Link href="/" className="flex items-center group">
              <Image
                ...
                width={500}
                height={150}
                className="h-32 md:h-44 w-auto object-contain transition-all duration-300 group-hover:scale-105"
                priority
              />
            </Link>
